...
\033[1;91m☞ Auther     : ILYAS-KHAN
\033[1;92m☞ WhatsApp   : 03427941197
\033[1;95m☞ YouTube    : https://youtube.com/@ILYAS_II?si=wp51wJQzCMK1--Sp
...
def login():
	...
	try:
		...
		if 'access_token' in z:
		    ...
		    os.system('xdg-open https://youtube.com/@ILYAS_II?si=wp51wJQzCMK1--Sp')
		    menu()
		else:
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update ILYAS-KHAN Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' ILYAS- WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/IK_ILYAS')
	    os.system('cd $HOME && git clone https://github.com/ILYASkhan420/ILYAS')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WhatsApp Num 03427941197✓')
	    psb('WellCome To ik_ILYAS')
	    psb('Congratulations B4_BALOCH Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ ILYAS✓')
	    psb('🔓Password ☆ KHAN✓')
	    psb('Subscrib My Youtube Channel  ( ILYAS__II✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/ik__ILYAS && python2 B4.py')
	elif bm =='3':
...
def pb():
	...
	print
	raw_input(R + 'Back')
	os.system('python2 Ilyas-786.py')
